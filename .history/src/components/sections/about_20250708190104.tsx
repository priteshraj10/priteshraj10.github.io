  ...
  const timelineData = workExperience.map((exp) => ({
    ...
    content: (
      <motion.article
        ...
        className="mb-12 bg-gradient-to-br from-slate-900/90 to-slate-800/80 rounded-2xl shadow-xl border border-blue-700/30 p-10 flex flex-col items-center md:items-start text-center md:text-left gap-4 max-w-2xl mx-auto hover:border-blue-400 hover:shadow-blue-500/30 transition-all duration-300"
      ...
      >
        ...
        <ul className="mb-0 list-disc list-inside text-white text-base md:text-lg pl-4 space-y-2 w-full">
