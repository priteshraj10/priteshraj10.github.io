...
export function HeroSection() {
  ...
  return (
    <section className="pt-20 pb-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center bg-zinc-800">
      <motion.div
      ...
      <motion.div
        ...
        className={cn(
          "mb-4 text-2xl md:text-4xl font-extrabold tracking-tight text-zinc-300"
        )}
      >
