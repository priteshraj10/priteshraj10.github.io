  ...
  const timelineData = [
      ...
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            Founder at CliniQX (QuadTree.ai)
          </p>
          <div className="mb-8">
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ✅ Founded AI-powered EHR/EMR platform
            </div>
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ✅ Developed custom medical LLM using Hugging Face & LangChain
            </div>
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ✅ Secured 5 Lakh INR seed funding from ISB&apos;s iVenture
            </div>
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            Data Scientist at ThrivePass
          </p>
          <div className="mb-8">
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ✅ Built scalable Python + Flask data pipeline
            </div>
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ✅ Automated delivery processes with SQL and cron jobs
            </div>
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ✅ Integrated OCR for document digitization
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <img
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            Machine Learning Engineer at Pretpick
          </p>
          <div className="mb-8">
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            Data Analyst (ML Research) at Cognitensor
          </p>
          <div className="mb-8">
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ✅ Developed surveillance system with OpenCV & TensorFlow
            </div>
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ✅ Implemented real-time object detection
            </div>
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ✅ Built face recognition & license plate detection
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <img
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            className="mt-16"
          >
            <h3 className="text-2xl font-bold text-zinc-800 dark:text-zinc-100 mb-8 text-center">
